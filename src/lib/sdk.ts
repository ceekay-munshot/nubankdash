...
export const DASHBOARD_ID = "nubank-brazil-market-share"; // <-- set per dashboard
export const DASHBOARD_NAME = "Nubank Brazil — Market Share & Asset Quality"; // <-- set per dashboard
